...
import { CircleX, Menu, PanelLeft, X } from "lucide-react"
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar shadow-[4px_4px_19px_0px_rgba(0,0,0,0.05)]
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "size-9 transition-all duration-200 ease-in-out",
        // No desktop: colapsado -> canto superior esquerdo; expandido -> dentro da sidebar
        // No mobile: Sheet fechado -> canto superior esquerdo; Sheet aberto -> dentro da sidebar
