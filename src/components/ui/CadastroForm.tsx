...
export default function CadastroForm() {
  ...
  return (
    <div>
      ...
      {/* Primeiro Modal */}
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} title="Cadastrar Colaborador">
     ...
     {/* Segundo Modal */}
     <Modal isOpen={isSecondModalOpen} onClose={() => setIsSecondModalOpen(false)} title="Cadastro de Jornada">
        <CadastroFormJornada 
          formData={formData}
