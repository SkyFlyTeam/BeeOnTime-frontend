...
export default function CadastroForm({ onClose }: { onClose: () => void }) {
  ...
  // Ao clicar em "Próximo", fecha o primeiro modal e abre o segundo
  ...
  return (
    <div>
      ...
      {/* Primeiro Modal */}
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} isSecondModal={false} title="Cadastrar Colaborador">
        <form onSubmit={handleNext} className="flex flex-col gap-4">
          <div className="flex gap-4"> {/* Usando flex para nome e cpf na mesma linha */}
     ...
     {/* Segundo Modal */}
     <Modal isOpen={isSecondModalOpen} onClose={() => setIsSecondModalOpen(false)} isSecondModal={true} title="Cadastrar Colaborador">
        <CadastroFormJornada
          formData={formData}
